...
![Original Visualizaion](/Users/zijiehe/Desktop/midimg/WechatIMG568.jpg) <br>
...
Here, his dataset is not given directly and I need to use beautifulsoup in python to extract the data. After extraction a csv is generated, the data generated csv is very messy, I need to use pandas for data cleaning. <br> ![Extract the data](/Users/zijiehe/Desktop/midimg/WechatIMG569.jpg) <br>
...
![Dataset](/Users/zijiehe/Desktop/midimg/redesign2/dataset.jpg) <br>

### Special efforts

The data on this site cannot be downloaded directly, we need to extract the data using python. <br> First, I need to INSPECT the html structure of the site, then find where the dataset is located, then extract the data using beautifulsoup. Use a csv to save the extracted data. But the data is messy and duplicated, all linked together. I want to use pandas for data cleaning. After cleaning the excess data, deal with null values. Then read the CSV using R. <br> ![Dataset](/Users/zijiehe/Desktop/midimg/redesign2/WechatIMG586.jpg)
...
Graph and Dataset: <br> Url: http://www.hyey.com/contents/29/13119.html <br> From: Anhui Huayuan Medicine News <br> Email: 490073403\@qq.com <br> Phone: (+86)0558-8233999 <br> Updated Date: 2023-06-28 <br>

Graph and Dataset: <br> Url: https://www.aoml.noaa.gov/hrd/hurdat/International_Hurricanes.html <br> From: Hurricane Research Division <br> Copyright © 2024 NOAA's Atlantic Oceanographic and Meteorological Laboratory. All Rights Reserved. <br>
