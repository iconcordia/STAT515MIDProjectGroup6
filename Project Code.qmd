...
I have embedded my codes in my original site as well as showing their results. I've also hidden the code in a box so that you can view each of my codes by clicking on "code". This separate code site is to make it easier to directly access my code and test and verify it!
